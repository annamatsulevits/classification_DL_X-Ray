...
base_dir = '/Users/annamatsulevits/Documents/GitHub/X_Ray_Classification/classification-challenge/classification-challenge-starter/Covid19-dataset'
...
plt.legend(['Training categorical_accuracy', 'val_categorical_accuracy '])
plt.title('Training and categorical_accuracy val_categorical_accuracy Trend')
plt.xlabel('Epochs')
